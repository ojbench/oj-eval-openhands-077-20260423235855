...
def main():
    ...
    code_parser.add_argument("--file", type=str, required=True, help="Path to code file")
    code_parser.add_argument("--language", type=str, default="cpp", help="Programming language (default: cpp)")
